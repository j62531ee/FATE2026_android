...
class EnhancedFATESuiteGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("🌟 FATE Suite 增強版 - 完整命理分析系統")
    ...
    def create_header(self):
        ...
        title_label = ttk.Label(header_frame, text="✨ FATE Suite 增強版 - 完整命理分析系統",
                               style='Header.TLabel')
        title_label.pack(side=tk.LEFT)

        subtitle_label = ttk.Label(header_frame, text="星座｜血型｜八字｜紫微｜塔羅｜周易",
                                  style='Status.TLabel')
